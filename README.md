# Collector for Ctrees Datasets
[![Build Status](https://github.com/OCHA-DAP/hdx-scraper-ctrees/actions/workflows/run-python-tests.yaml/badge.svg)](https://github.com/OCHA-DAP/hdx-scraper-ctrees/actions/workflows/run-python-tests.yaml)
...
product is out of scope). See `docs/analysis/HDXPIPE-100-ctrees.md` for the full design rationale.
 ...
 **hdx-scraper-ctrees** as specified in the parameter
 *user_agent_lookup*.
