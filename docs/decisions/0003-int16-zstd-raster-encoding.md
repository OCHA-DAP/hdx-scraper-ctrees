...
CLAUDE.md's "Known Limitations" section: find the actual upload limit, tile
large countries into multiple resources, or accept per-country skip via the
failure-isolation fix in 0004). A GDAL-aware tool (QGIS
